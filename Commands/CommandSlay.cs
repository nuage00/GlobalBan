    ...
    public class CommandSlay : IRocketCommand
    {
        ...
        public void Execute(IRocketPlayer caller, params string[] command)
        {
            ...
            if (command.Length >= 2)
            {
                ...
                Provider.ban(steamPlayerId.steamID, command[1], 31536000);
                ...
                Discord.SendWebhookPost(GlobalBan.Instance.Configuration.Instance.DiscordBanWebhook,
                    Discord.BuildDiscordEmbed("A player was banned from the server.",
                        $"{steamPlayerId.playerName} was banned from the server for {command[1]}!", "Global Ban",
                        ...
                        new[]
                        {
                            Discord.BuildDiscordField("Steam64ID", steamPlayerId.steamID.ToString(), true),
            ...
            else
            {
                ...
                Provider.ban(steamPlayerId.steamID, GlobalBan.Instance.Translate("command_ban_private_default_reason"),
                    31536000);

                Discord.SendWebhookPost(GlobalBan.Instance.Configuration.Instance.DiscordBanWebhook,
                    Discord.BuildDiscordEmbed("A player was banned from the server.",
                        $"{steamPlayerId.playerName} was banned from the server for {GlobalBan.Instance.Translate("command_ban_private_default_reason")}!",
                        "Global Ban",
                        "https://imperialproduction.blob.core.windows.net/shopcoreproducts/productlogos/194/13260ab6-c9b2-d350-64f3-39f360c60fe6/thumbnail.png",
                        GlobalBan.Instance.Configuration.Instance.DiscordBanWebhookColor,
                        new[]
